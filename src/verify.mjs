...
for (const f of ['chat.js', 'counters.js', 'build.mjs', 'ui.js']) {
...
const PAGES = ['index.html', 'parents/index.html', 'embed/index.html', '404.html'];
...
for (const f of ['calc.js', 'ui.js', 'chat.js', 'counters.js']) {
